...
export default function Education(){
    return (
        <Layout>
            ...
            <EducationCard school="Tsinghua University" time="2019.7 - Present" department="Department of Computer Science and Technology" degree="Student, Bachelor of Engineering in Science" img_path="/images/tsinghua.png"/>
